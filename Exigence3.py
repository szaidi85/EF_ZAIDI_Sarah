...
assert driver.current_url == "http://tutorialsninja.com/demo/index.php?route=account/register"
message = driver.find_element(By.XPATH, "//div[@class='alert alert-danger alert-dismissible']").text
assert message == "Warning: E-Mail Address is already registered!", "Congratulations! Your new account has been " \
